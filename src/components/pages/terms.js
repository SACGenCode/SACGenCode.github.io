        ...
        <React.Fragment>
            <section className="section">
                <div className="container">
                    ...
                    <h2 className="title mt-5">Welcome to SAC Gen-Code</h2>
                    <p>These terms of service outline the rules and regulations for the use of SAC Gen-Code's Website.</p>


                    <p>By accessing this website we assume you accept these terms of service in full. Do not continue to use
                        SAC Gen-Code's website if you do not accept all of the terms of service stated on this page.</p>
                    ...
                    <h2 className="title mt-5">Cookies</h2>
                    <p>We employ the use of cookies. By using SAC Gen-Code's website you consent to the use of cookies
                        in accordance with SAC Gen-Code's privacy policy.</p>
                    ...
                    <h2 className="title mt-5">License</h2>
                    <p>Unless otherwise stated, SAC Gen-Code and/or it's licensors own the intellectual property rights for
                        all material on SAC Gen-Code. All intellectual property rights are reserved. You may view and/or print
                        pages from sacgencode.js.org for your own personal use subject to restrictions set in these terms of service.</p>
                    <p>You must not:</p>
                    <ol>
                        <li>Republish material from sacgencode.js.org</li>
                        <li>Sell, rent or sub-license material from sacgencode.js.org</li>
                        <li>Reproduce, duplicate or copy material from sacgencode.js.org</li>
                    </ol>
                    <p>Redistribute content from SAC Gen-Code (unless content is specifically made for redistribution).</p>


                    <h2 className="title mt-5">User Comments</h2>
                    <ol>
                        <li>This Agreement shall begin on the date hereof.</li>
                        <li>Certain parts of this website offer the opportunity for users to post and exchange opinions, information,
                            material and data ('Comments') in areas of the website. SAC Gen-Code does not screen, edit, publish
                            or review Comments prior to their appearance on the website and Comments do not reflect the views or
                            opinions of SAC Gen-Code, its agents or affiliates. Comments reflect the view and opinion of the
                            person who posts such view or opinion. To the extent permitted by applicable laws SAC Gen-Code shall
                            ...
                            website.</li>
                        <li>SAC Gen-Code reserves the right to monitor all Comments and to remove any Comments which it considers
                    ...
                    <h2 className="title mt-5">Removal of links from our website</h2>
                    ...
                    <h2 className="title mt-5">Disclaimer</h2>
                    ...
                    <p>To the extent that the website and the information and services on the website are provided free of charge,
                        we will not be liable for any loss or damage of any nature.</p><h2 className="title mt-5">Credit &amp; Contact Information</h2>
                    <p> If you have
